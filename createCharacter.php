    ...
    <div class="create-character-container">
        ...
        <form method="POST">
            ...
            <select id="race" name="race">
                <option value="Saiyan">Miyagi-Do</option>
                <option value="Namek">Cobra Kai </option>
                <option value="Humano">Eagle Fang</option>
                <option value="Freezer Race">Pacificos</option>
                <option value="Majin">Demonios</option>
            </select>
