...
<div class="dashboard-container">
    ...
    <div class="card">
     ...
     <div class="card">
        <h3>Modo Online</h3>
        <p>Podrás jugar en modo multijugador con tus amigos u otros jugadores. </p>
        <a href="leaderboard.php">Modo Online</a>
    </div>
    <div class="card">
        <h3>Agregar Jugadores</h3>
        <p>Manda solicitudes de amistad para jugar con amigos. </p>
        <a href="leaderboard.php">Aregar Jugador</a>
    </div>
